...
for pt in zip(*loc[::-1]):
    ...
    #data = pytesseract.image_to_data(crop_final, lang=None, config='', nice=0, output_type=Output.STRING, timeout=0, pandas_config=None)
    #print(data)

    #boxes = pytesseract.image_to_boxes(crop_final)
    #print(boxes)
